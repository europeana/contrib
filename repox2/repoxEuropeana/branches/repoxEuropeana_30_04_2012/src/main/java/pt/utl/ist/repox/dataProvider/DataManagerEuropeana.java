...
public class DataManagerEuropeana implements DataManager {
    ...
    public DataManagerEuropeana(File dataFile, MetadataTransformationManager metadataTransformationManager, File repositoryPath,
                                File oldTasksFile, File defaultExportDir) throws DocumentException, IOException, ParseException {
        super();
...
//                    }
                    ...
                    if(dataSource != null){
                        ...
                        for(Object node: servicesList) {
                            ...
                            ExternalRestService externalRestService = new ExternalRestService(serviceId,
                                    serviceName,serviceUri,serviceType,serviceStatusUri);
...
//                        dataProvider.getDataSourceContainers().clear();
    ...
    public DataSource createDataSourceOai(String dataProviderId, String id, String description,
                                          ...
                                          List<ExternalRestService> externalRestServices) throws DocumentException, IOException, InvalidArgumentsException, ObjectNotFoundException, AlreadyExistsException, SQLException {
                ...
                if(dataProvider != null){
                    ...
                    if(new java.net.URL(oaiSourceURL).openConnection().getHeaderField(0) != null && FileUtil.checkUrl(oaiSourceURL)){
                        DataSource newDataSource = new DataSourceOai(dataProvider, id, description, schema, namespace, metadataFormat,
                                oaiSourceURL, oaiSet, new IdGenerated(), new TreeMap<String, MetadataTransformation>());
    ...
    public DataSource createDataSourceZ3950IdList(String dataProviderId, String id, String description,
                                                  ...
                                                  String namespaceUri, Map<String, MetadataTransformation> metadataTransformations,
        ...
        return createDataSourceZ3950IdList(dataProviderId, id, description, nameCode, name, exportPath, schema, namespace,
                address, port, database, user, password, recordSyntax, charset, filePath, recordIdPolicyClass, idXpath,
    ...
    public DataSource createDataSourceZ3950Timestamp(String dataProviderId, String id, String description,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceZ3950Timestamp(dataProviderId, id, description, nameCode, name, exportPath, schema, namespace,
                address, port, database, user, password, recordSyntax, charset, earliestTimestampString, recordIdPolicyClass,
                idXpath, namespaces, metadataTransformations,externalRestServices);
    }
    ...
    public DataSource createDataSourceZ3950IdSequence(String dataProviderId, String id, String description,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceZ3950IdSequence(dataProviderId, id, description, nameCode, name, exportPath, schema,
                namespace, address, port, database, user, password, recordSyntax, charset, maximumIdString,
                recordIdPolicyClass, idXpath, namespaces, metadataTransformations,externalRestServices);
    }
    ...
    public DataSource createDataSourceFtp(String dataProviderId, String id, String description,
                                          ...
                                          Map<String, MetadataTransformation> metadataTransformations,
                                          List<ExternalRestService> externalRestServices) throws DocumentException, IOException, InvalidArgumentsException, ObjectNotFoundException, SQLException, AlreadyExistsException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceFtp(dataProviderId, id, description, nameCode, name, exportPath, schema, namespace,
                metadataFormat, isoFormat, charset, recordIdPolicyClass, idXpath, namespaces, recordXPath, server, user,
                password, ftpPath, metadataTransformations,externalRestServices);
    }
    public DataSource createDataSourceFtp(String dataProviderId, String id, String description,
                                          String nameCode, String name, String exportPath, String schema, String namespace,
                                          String metadataFormat, String isoFormat, String charset,
    ...
    public DataSource createDataSourceHttp(String dataProviderId, String id, String description,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceHttp(dataProviderId, id, description, nameCode, name, exportPath, schema, namespace,
                metadataFormat, isoFormat, charset, recordIdPolicyClass, idXpath,  namespaces, recordXPath, url, metadataTransformations,
    ...
    public DataSource createDataSourceFolder(String dataProviderId, String id, String description,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceFolder(dataProviderId, id, description, nameCode, name, exportPath, schema, namespace,
                metadataFormat, isoVariant, charset, recordIdPolicyClass, idXpath, namespaces, recordXPath, sourcesDirPath,
    ...
    public DataSource updateDataSourceOai(String oldId, String id, String description,
                                          ...
                                          String metadataFormat, String oaiSourceURL, String oaiSet,
                                          Map<String, MetadataTransformation> metadataTransformations,
                                          List<ExternalRestService> externalRestServices) throws DocumentException, IOException, ObjectNotFoundException, InvalidArgumentsException, IncompatibleInstanceException {
...
//                            dataSourceContainer.setExportPath(exportPath);
    ...
    public DataSource updateDataSourceZ3950Timestamp(String oldId, String id, String description,
                                                     ...
                                                     String recordIdPolicyClass, String idXpath, String namespacePrefix,
                                                     String namespaceUri, Map<String, MetadataTransformation> metadataTransformations,
                                                     List<ExternalRestService> externalRestServices) throws DocumentException, IOException, ParseException, ObjectNotFoundException, IncompatibleInstanceException, InvalidArgumentsException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceZ3950Timestamp(oldId, id, description, nameCode, name, exportPath, schema, namespace,
                address, port, database, user, password, recordSyntax, charset, earliestTimestampString,
                recordIdPolicyClass, idXpath, namespaces, metadataTransformations,externalRestServices);
    }
...
//                        dataSourceContainer.setExportPath(exportPath);
    ...
    public DataSource updateDataSourceZ3950IdList(String oldId, String id, String description, String nameCode, String name,
                                                  ...
                                                  String namespacePrefix, String namespaceUri, Map<String, MetadataTransformation> metadataTransformations,
                                                  List<ExternalRestService> externalRestServices) throws DocumentException, IOException, ParseException, InvalidArgumentsException, ObjectNotFoundException, IncompatibleInstanceException {

        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceZ3950IdList(oldId, id, description, nameCode, name, exportPath, schema, namespace, address,
                port, database, user, password, recordSyntax, charset, filePath, recordIdPolicyClass, idXpath,
                namespaces, metadataTransformations,externalRestServices);
    }
...
//                        dataSourceContainer.setExportPath(exportPath);
    ...
    public DataSource updateDataSourceZ3950IdSequence(String oldId, String id, String description, String nameCode,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceZ3950IdSequence(oldId, id, description, nameCode, name, exportPath, schema, namespace,
                address, port, database, user, password, recordSyntax, charset, maximumIdString, recordIdPolicyClass,
                idXpath, namespaces, metadataTransformations,externalRestServices);
    }
...
//                        dataSourceContainer.setExportPath(exportPath);
    ...
    public DataSource updateDataSourceFtp(String oldId, String id, String description, String nameCode, String name,
                                          ...
                                          Map<String, MetadataTransformation> metadataTransformations,
                                          List<ExternalRestService> externalRestServices) throws DocumentException, IOException, InvalidArgumentsException, ObjectNotFoundException, IncompatibleInstanceException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceFtp(oldId, id, description, nameCode, name, exportPath, schema, namespace, metadataFormat,
                isoFormat, charset, recordIdPolicyClass, idXpath, namespaces, recordXPath, server, user, password,
                ftpPath, metadataTransformations,externalRestServices);
    }
    ...
    public DataSource updateDataSourceFtp(String oldId, String id, String description, String nameCode, String name,
        ...
        if(dataSourceContainer != null){
            ...
            if(dataSource instanceof DataSourceDirectoryImporter &&
                    ((DataSourceDirectoryImporter)dataSource).getRetrieveStrategy() instanceof DataSourceFtp){
                if(!isIdValid(id))
                    throw new InvalidArgumentsException(id);
...
//                            dataSourceContainer.setExportPath(exportPath);
    ...
    public DataSource updateDataSourceHttp(String oldId, String id, String description, String nameCode, String name,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceHttp(oldId, id, description, nameCode, name, exportPath, schema, namespace, metadataFormat,
                isoFormat, charset, recordIdPolicyClass, idXpath, namespaces, recordXPath, url, metadataTransformations,
                externalRestServices);
    }
    ...
    public DataSource updateDataSourceHttp(String oldId, String id, String description, String nameCode, String name,
        ...
        if(dataSourceContainer != null){
            DataSource dataSource = dataSourceContainer.getDataSource();
            if(dataSource instanceof DataSourceDirectoryImporter &&
                    ((DataSourceDirectoryImporter)dataSource).getRetrieveStrategy() instanceof DataSourceHttp){
                if(!isIdValid(id))
                    throw new InvalidArgumentsException(id);
...
//                            dataSourceContainer.setExportPath(exportPath);
    ...
    public DataSource updateDataSourceFolder(String oldId, String id, String description, String nameCode, String name,
                                             ...
                                             List<ExternalRestService> externalRestServices) throws IOException, DocumentException, InvalidArgumentsException, ObjectNotFoundException, IncompatibleInstanceException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceFolder(oldId, id, description, nameCode, name, exportPath,  schema, namespace, metadataFormat,
                isoFormat, charset, recordIdPolicyClass, idXpath, namespaces, recordXPath, sourcesDirPath, metadataTransformations,
                externalRestServices);
    }
    ...
    public DataSource updateDataSourceFolder(String oldId, String id, String description, String nameCode, String name,
        ...
        if(dataSourceContainer != null){
            DataSource dataSource = dataSourceContainer.getDataSource();
            if(dataSource instanceof DataSourceDirectoryImporter &&
                    ((DataSourceDirectoryImporter)dataSource).getRetrieveStrategy() instanceof DataSourceFolder){
                if(!isIdValid(id))
                    throw new InvalidArgumentsException(id);
