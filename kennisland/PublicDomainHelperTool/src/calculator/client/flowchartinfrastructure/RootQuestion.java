...
/**
 * Always points to the rootQuestion of a flowchart, use whenever lost in the
 * tree or for plain reset functions
 * 
 * @author mzeinstra
 * 
 */
public class RootQuestion {
    ...
    public void doneWriting(String q) {
        if (writtenQuestions.contains(q)) {
            writtenQuestions.remove(q);
        }
    }
