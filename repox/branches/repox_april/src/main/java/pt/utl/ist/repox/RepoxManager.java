...
public class RepoxManager {
	...
	public RepoxManager(RepoxConfiguration configuration, String dataProvidersFilename, String statisticsFilename,
		...
		this.dataProviderManager = new DataProviderManager(dataProvidersFile, this.metadataTransformationManager);
		...
		accessPointsManager.initialize(dataProviderManager.loadDataSources());
