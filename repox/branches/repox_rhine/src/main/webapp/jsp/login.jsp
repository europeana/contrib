...
<html>
    <head><title><fmt:message key="authentication" /></title></head>
    ...
    <body onload="document.f.j_username.focus();">
        ...
        <form name="f" action="<c:url value='/j_spring_security_check'/>" method="POST">
            <table style="margin-left: auto; margin-right: auto;">
                ...
                <tr><td colspan="2"><input type="checkbox" name="_spring_security_remember_me"/> <fmt:message key="authentication.dontAskPassword" /></td></tr>

                <c:set var="submitButton"><fmt:message key="common.submit" /></c:set>
                <c:set var="resetButton"><fmt:message key="common.reset" /></c:set>
                <tr><td><input name="submit" type="submit" value="${submitButton}"/> <input name="reset" type="reset" value="${resetButton}"/></td></tr>
            </table>
