...
@Results({ @Result(name = "error", location = "projectstatistics.jsp"),//projectstatistics.jsp
		@Result(name = "success", location = "projectstatistics.jsp") })//projectstatistics.jsp
