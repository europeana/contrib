...
public class DataSet implements Serializable {
    ...
    @Column
    private String oaiSetInput;

    @Column
    private String oaiSetOutput;
     ...
     *
     * @param id Long  the DataSet identifier
     */
    ...
    /**
     * Get the OAI set.  A {@link <a href="http://www.openarchives.org/OAI/openarchivesprotocol.html#Set">Set</a>}
     * is an optional construct for grouping items for the purpose of selective harvesting.
     *
     * @return String
     */
    public String getOaiSetInput() {
        return oaiSetInput;
    }

    /**
     * Set the OAI set.  A {@link <a href="http://www.openarchives.org/OAI/openarchivesprotocol.html#Set">Set</a>}
     * is an optional construct for grouping items for the purpose of selective harvesting.
     *
     * @param oaiSetInput String
     */
    public void setOaiSetInput(String oaiSetInput) {
        this.oaiSetInput = oaiSetInput;
    }

    /**
     * Get the oai set output
     *
     * @return String
     */
    public String getOaiSetOutput() {
        return oaiSetOutput;
    }

    /**
     * Set the Oai Set Output
     *
     * @param oaiSetOutput String
     */
    public void setOaiSetOutput(String oaiSetOutput) {
        this.oaiSetOutput = oaiSetOutput;
    }
    ...
    public boolean equalsIgnoreId(Object o) {
        ...
        if (oaiSetInput != null ? !oaiSetInput.equals(dataSet.oaiSetInput) : dataSet.oaiSetInput != null) {
            return false;
        }
        if (oaiSetOutput != null ? !oaiSetOutput.equals(dataSet.oaiSetOutput) : dataSet.oaiSetOutput != null) {
            return false;
        }
    ...
    public String toString() {
        return "DataSet{" +
                ...
                ", oaiSetInput='" + oaiSetInput + '\'' +
                ", oaiSetOutput='" + oaiSetOutput + '\'' +
                ", requests=" + requests +
                '}';
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (oaiSetInput != null ? oaiSetInput.hashCode() : 0);
        result = 31 * result + (oaiSetOutput != null ? oaiSetOutput.hashCode() : 0);
