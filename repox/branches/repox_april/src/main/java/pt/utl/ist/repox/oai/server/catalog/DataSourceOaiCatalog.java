...
public class DataSourceOaiCatalog extends AbstractCatalog {
    ...
    public Map<String, String> getRepoxSchemaLocations(String identifier) throws IdDoesNotExistException, NoMetadataFormatsException {
    	...
    	try {
    		if(identifier == null || identifier.isEmpty()) {
    			...
    			DataSource dataSource = RepoxContextUtil.getRepoxManager().getDataProviderManager().getDataSource(urn.getDataSourceId());
    			addDataSourceSchemaLocations(schemaLocationsMap, dataSource);
    		}
		}
		catch (Exception e) {
     ...
     */
    @Override
	public Map listIdentifiers(String from, String until, String set, String metadataPrefix) throws BadArgumentException {
     ...
     */
    @Override
	public Map listRecords(String from, String until, String set, String metadataPrefix) throws CannotDisseminateFormatException, BadArgumentException {
    	purge(); // clean out old resumptionTokens
	...
	private Map getListRecords(String resumptionToken, boolean fullRecord) throws CannotDisseminateFormatException, BadArgumentException {
	...
	private Map getListRecords(String from, String until, String set, String metadataPrefix, int offset, boolean fullRecord)
		...
		try {
			dataSource = RepoxContextUtil.getRepoxManager().getDataProviderManager().getDataSource(set);
			if(dataSource == null) {
	...
	public String getRecord(String identifier, String metadataPrefix) throws CannotDisseminateFormatException, IdDoesNotExistException {
		...
		try {
			...
			dataSource = RepoxContextUtil.getRepoxManager().getDataProviderManager().getDataSource(urn.getDataSourceId());
