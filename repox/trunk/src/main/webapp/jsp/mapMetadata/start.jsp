	...
	<body>
		...
		<fieldset>
			...
			<stripes:form action="/mapMetadata/MapMetadata.action" acceptcharset="UTF-8">
                ...
                <%-- <p>
                  <legend><fmt:message key="metadataTransformation.OptionVersion" /><em>*</em></legend>
                    <select name="metadataTransformation.OptionVersion">
                        <option value="Version1">Version 1.0</option>
                        <option value="Version2">Version 2.0</option>
                    </select>
                </p>--%>
                <p>
                    <label for="valueVersion"><fmt:message key="metadataTransformation.isVersion2" /><em>*</em></label>
                    <stripes:checkbox name="metadataTransformation.versionTwo"/>
                </p>
                <p>
