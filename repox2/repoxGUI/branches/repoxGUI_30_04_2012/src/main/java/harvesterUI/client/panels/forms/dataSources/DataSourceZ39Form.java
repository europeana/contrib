...
public class DataSourceZ39Form extends DataSourceForm {
    ...
    private TextField<String> address, port, database, user, password,idXPathField,schema, metadataNamespace;
    ...
    private void saveZ39DataSet(){
        ...
        if(HarvesterUI.getProjectType().equals("EUROPEANA"))
            saveDataSource(dataSourceUI,oldDataSetId,"z39",schema.getValue(),metadataNamespace.getValue(),
...
//                    dataSet.add(fileUploadField,smallFixedFormData);
        ...
        schema.setValue("info:lc/xmlns/marcxchange-v1.xsd");
        ...
        metadataNamespace.setValue("info:lc/xmlns/marcxchange-v1");
