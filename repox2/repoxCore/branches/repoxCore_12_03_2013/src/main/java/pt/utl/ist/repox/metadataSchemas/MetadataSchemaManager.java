...
//                metadataSchemaElement.addElement("creationDate").setText(metadataSchema.getCreationDate().toString());
    ...
    public void deleteMetadataSchema(String metadataSchemaId){
        for(MetadataSchema metadataSchema : metadataSchemas){
            if(metadataSchemaId.equals(metadataSchema.getShortDesignation())){
    ...
    private void fillDefaultData(){
        ...
        saveMetadataSchema(null, "ese", null, "http://www.europeana.eu/schemas/ese/", null, "",metadataSchemaVersions);
        ...
        saveMetadataSchema(null,"MarcXchange",null,"info:lc/xmlns/marcxchange-v1",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(1.0,"info:lc/xmlns/marcxchange-v1.xsd"));
        saveMetadataSchema(null,"ISO2709",null,"info:lc/xmlns/marcxchange-v1",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(3.4,"http://www.europeana.eu/schemas/ese/ESE-V3.4.xsd"));
        saveMetadataSchema(null,"tel",null,"http://krait.kb.nl/coop/tel/handbook/telterms.html",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(2.0,"http://www.openarchives.org/OAI/2.0/oai_dc.xsd"));
        saveMetadataSchema(null,"oai_dc",null,"http://www.openarchives.org/OAI/2.0/",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(2.0,"ncbi-mathml2/mathml2.xsd"));
        saveMetadataSchema(null,"NLM-AI",null,"http://www.w3.org/1998/Math/MathML",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(2.0,"ncbi-mathml2/mathml2.xsd"));
        saveMetadataSchema(null,"NLM-Book",null,"http://www.w3.org/1998/Math/MathML",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(1.0,"http://www.lido-schema.org/schema/v1.0/lido-v1.0.xsd"));
        saveMetadataSchema(null,"lido",null,"http://www.lido-schema.org",null,"",metadataSchemaVersions);

        metadataSchemaVersions = new ArrayList<MetadataSchemaVersion>();
        metadataSchemaVersions.add(new MetadataSchemaVersion(1.0,"http://www.europeana.eu/schemas/edm/EDM.xsd"));
        saveMetadataSchema(null,"edm",null,"http://www.europeana.eu/schemas/edm/",null,"",metadataSchemaVersions);
    }
}
