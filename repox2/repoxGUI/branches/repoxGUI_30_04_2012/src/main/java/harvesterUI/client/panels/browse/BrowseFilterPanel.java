    ...
    public BrowseFilterPanel() {
        ...
        startFilterButton.addSelectionListener(new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent me) {
                List<FilterQuery> filterQueries = getAllQueries();
                Dispatcher.forwardEvent(AppEvents.FilterData,filterQueries);
            }
        });
...
//        DataFilter mostRecent = new DataFilter(HarvesterUI.CONSTANTS.recent(),"used");

//        Attribute ingestType = new AttributeIngestType(HarvesterUI.CONSTANTS.ingestType(),"ingestType");
...
//        attributesListStore.add(mostRecent);
//        attributesListStore.add(ingestType);
    ...
    private List<FilterQuery> getAllQueries(){
