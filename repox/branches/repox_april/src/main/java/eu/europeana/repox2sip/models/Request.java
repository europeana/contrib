...
public class Request implements Serializable {
    ...
    @JoinColumn(name = "dataset_id", unique = true, nullable = false)
    ...
    @Column
    @ManyToMany(targetEntity = MetadataRecord.class)
    @JoinTable(name = "request_md_record",
            joinColumns = {@JoinColumn(name = "md_record_id")},
