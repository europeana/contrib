...
//            else if(projectType == ProjectType.EUDML){
//                WebServicesImplEuDML webServicesImplEuDML = new WebServicesImplEuDML();
//                responseRest = new ResponseRestEuDML();
//                responseRest.response(request, response, webServicesImplEuDML);
//            }
            else if(projectType == ProjectType.EUROPEANA){
...
//            else if(projectType == ProjectType.EUDML){
//                webServices = new WebServicesImplEuDML();
//            }
            else if(projectType == ProjectType.EUROPEANA){
...
//            else if(webServices instanceof WebServicesImpl || webServices instanceof WebServicesImplEuDML){
