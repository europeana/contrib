		...
		<table class="mainTable">
					...
					<th class="mainHeader" colspan="7">
						<stripes:form action="/dataProvider/CreateEditDataProvider.action" acceptcharset="UTF-8">
							...
							<div style="float:left; width: 80%;">
								<!-- 
								<c:if test="${!empty actionBean.dataProvider.logo}">
									<img title="logo" alt="logo" height="40px" src="${pageContext.request.contextPath}/dataProvider/ViewDataProvider.action?viewLogoImage&dataProviderId=${actionBean.dataProvider.id}" />
								</c:if>
								 -->
								 <c:if test="${!empty actionBean.dataProvider.country}">
									<img title="${repox:getCountries()[actionBean.dataProvider.country]}" alt="${repox:getCountries()[actionBean.dataProvider.country]}"
										 src="${pageContext.request.contextPath}/jsp/images/countries/${actionBean.dataProvider.country}.png" />
								</c:if>
			...
			<tr><td colspan="7">
				<stripes:link href="/dataProvider/CreateEditDataSourceDirectoryImporter.action">
		           	...
		           	<stripes:param name="dataSource.metadataFormat" value="ISO2709"/>
		        </stripes:link>
	        </td></tr>
		</table>
	</body>
