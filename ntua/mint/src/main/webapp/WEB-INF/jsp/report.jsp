...
<%@ include file="top.jsp" %><%@page import="java.util.List"%>
...
<script type="text/javascript">
		...
		function showSlider(e){
			 slider=xGetElementById("slider"+e);
			 container=xGetElementById("s"+e+"_container");
			 var anim = new YAHOO.util.Anim(slider,{height:{to:200}},1,YAHOO.util.Easing.easeOut);
...
<s:else>
<div id="help">
<p style="margin-left:5px;">Data report for every organization per country (<a title="Download CSV file " href="ReportSummary?download=csv">Download</a>):
     </p>
</div>
