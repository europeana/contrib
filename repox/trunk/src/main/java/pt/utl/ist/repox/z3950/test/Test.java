...
public class Test {
	...
	public DataSourceZ3950 createDummyDataSource(HarvestMethod harvestMethod) throws IOException, DocumentException, SQLException, Repox2SipException {
		// todo insert aggregator (null is this moment)
        DataProvider dummyDP = new DataProvider(null, "tempDP", "tempDP", "temporary Data Provider - delete", new ArrayList<DataSource>());
		DataSourceZ3950 dataSourceZ3950 = new DataSourceZ3950(dummyDP, "tempZ3950", "tempZ3950", harvestMethod, new IdGenerated(), null, null, null, -1, null);
		dummyDP.getDataSources().add(dataSourceZ3950);
		RepoxContextUtil.getRepoxManager().getDataManager().saveDataProvider(dummyDP);
	...
	private void deleteDummyDataSource(DataSourceZ3950 dataSourceZ3950) throws IOException, DocumentException, Repox2SipException {
		String dataProviderId = dataSourceZ3950.getDataProvider().getId();
		RepoxContextUtil.getRepoxManager().getDataManager().deleteDataProvider(dataProviderId);
	}
	
	public static void main(String[] args) throws ParseException, IOException, DocumentException, SQLException, Repox2SipException {
...
//		test.deleteDummyDataSource(dataSourceZ3950); System.exit(0);
		...
		dataSourceZ3950.ingestRecords(new Request(), logFile, false);
	}
