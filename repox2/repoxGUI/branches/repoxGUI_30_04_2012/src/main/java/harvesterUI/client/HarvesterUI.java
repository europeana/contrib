...
import harvesterUI.client.servlets.*;
...
//                    Dispatcher.forwardEvent(AppEvents.ViewAccordingToRole, userRole);
//                } else {
//                    Cookies.removeCookie("sid");
//                    Dispatcher.forwardEvent(AppEvents.Login);
//                    GXT.hideLoadingPanel("loading");
//                }
//                userRole = Cookies.getCookie("userRole");
                // Only add the history controller for logged user
                String usrName = Cookies.getCookie("loggedUsrName");
...
//            }
            ...
            if(historyToken.equals("OVERVIEW_GRID"))
                Dispatcher.forwardEvent(AppEvents.LoadMainData);
            else
            ...
            }else if(historyToken.equals("SCHEMA_MAPPER"))
    ...
    private void startRepoxData(){
        // Get Project Version
        AsyncCallback<String> projectTypeCall = new AsyncCallback<String>(){
            public void onFailure(Throwable caught) {
                Window.alert("Error: session could not be loaded.");
            }
            public void onSuccess(String project) {
                Registry.register("PROJECT_TYPE", project);
        ...
        repoxService.getRepoxProjectType(projectTypeCall);
    }
