...
public class NewSchemaDialog extends FormDialog {
    ...
    private void createNewSchemaDialog() {
        ...
        generalInfoSet.setHeading("Schema Information");
                ...
                AsyncCallback<ResponseState> callback = new AsyncCallback<ResponseState>() {
                    ...
                    public void onSuccess(ResponseState responseState) {
                        if(responseState == ResponseState.ALREADY_EXISTS){
                            HarvesterUI.UTIL_MANAGER.getInfoBox("New Metadata Schema","Metadata Schema with that short designation already exists");
                            return;
                        }
                        hide();
        ...
        Button addButton = new Button("Add Schema Version",HarvesterUI.ICONS.schema_version_new(), new SelectionListener<ButtonEvent>() {
            @Override
            public void componentSelected(ButtonEvent be) {
                newSchemaVersionFieldSet.addNewField();
            }
        });
