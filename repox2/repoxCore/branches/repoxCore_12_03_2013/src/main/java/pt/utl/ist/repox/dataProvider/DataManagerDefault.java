...
public class DataManagerDefault implements DataManager{
    ...
    public DataManagerDefault(File dataProvidersFile, MetadataTransformationManager metadataTransformationManager,
                              ...
                              File repositoryPath, File oldTasksFile) throws DocumentException, IOException, ParseException {
        super();
        this.dataProvidersFile = dataProvidersFile;
        this.metadataTransformationManager = metadataTransformationManager;
                    ...
                    if(dataSource != null){
                        ...
                        for(Object node: servicesList) {
                            ...
                            ExternalRestService externalRestService = new ExternalRestService(serviceId,
                                    serviceName,serviceUri,serviceStatusUri,serviceType);
...
/*
    ...
    public DataSource createDataSourceOai(String dataProviderId, String id, String description,
                                          ...
                                          List<ExternalRestService> externalRestServices) throws DocumentException,
    ...
    public DataSource createDataSourceZ3950IdList(String dataProviderId, String id, String description, String schema, String namespace,
        ...
        return createDataSourceZ3950IdList(dataProviderId, id, description, schema, namespace, address, port, database,
                user, password, recordSyntax, charset, filePath, recordIdPolicyClass, idXpath, namespaces, metadataTransformations,
    ...
    public DataSource createDataSourceZ3950Timestamp(String dataProviderId, String id, String description, String schema, String namespace,
        ...
        return createDataSourceZ3950Timestamp(dataProviderId, id, description, schema, namespace, address, port, database,
                user, password, recordSyntax, charset, earliestTimestampString, recordIdPolicyClass, idXpath, namespaces,
    ...
    public DataSource createDataSourceZ3950IdSequence(String dataProviderId, String id, String description, String schema, String namespace,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceZ3950IdSequence(dataProviderId, id, description, schema, namespace, address, port, database,
                user, password, recordSyntax, charset, maximumIdString, recordIdPolicyClass, idXpath, namespaces,
                metadataTransformations,externalRestServices);
    }
    public DataSource createDataSourceZ3950IdSequence(String dataProviderId, String id, String description, String schema, String namespace,
                                                      String address, String port, String database, String user, String password,
    ...
    public DataSource createDataSourceFtp(String dataProviderId, String id, String description, String schema, String namespace,
                                          ...
                                          Map<String, MetadataTransformation> metadataTransformations,
                                          List<ExternalRestService> externalRestServices) throws DocumentException, IOException, AlreadyExistsException, ObjectNotFoundException, InvalidArgumentsException, SQLException {

        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);

        return createDataSourceFtp(dataProviderId, id, description, schema, namespace, metadataFormat, isoFormat, charset,
                recordIdPolicyClass, idXpath, namespaces, recordXPath, server, user, password, ftpPath, metadataTransformations,
                externalRestServices);
    }
    ...
    public DataSource createDataSourceHttp(String dataProviderId, String id, String description, String schema, String namespace,
        ...
        return createDataSourceHttp(dataProviderId, id, description, schema, namespace, metadataFormat, isoFormat, charset,
                recordIdPolicyClass, idXpath, namespaces, recordXPath, url, metadataTransformations,
                externalRestServices);
    }
    ...
    public DataSource createDataSourceFolder(String dataProviderId, String id, String description, String schema, String namespace,
                                             ...
                                             List<ExternalRestService> externalRestServices) throws DocumentException, IOException, ObjectNotFoundException, AlreadyExistsException, InvalidArgumentsException, SQLException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return createDataSourceFolder(dataProviderId, id, description, schema, namespace, metadataFormat, isoVariant,
                charset, recordIdPolicyClass, idXpath, namespaces, recordXPath, sourcesDirPath, metadataTransformations,externalRestServices);
    }
    ...
    public DataSource updateDataSourceZ3950Timestamp(String oldId, String id, String description, String schema, String namespace,
                                                     ...
                                                     String recordIdPolicyClass, String idXpath, String namespacePrefix,
                                                     String namespaceUri, Map<String, MetadataTransformation> metadataTransformations,
                                                     List<ExternalRestService> externalRestServices) throws DocumentException, IOException, ParseException, ObjectNotFoundException, InvalidArgumentsException, IncompatibleInstanceException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceZ3950Timestamp(oldId, id, description, schema, namespace, address, port, database, user,
                password, recordSyntax, charset, earliestTimestampString, recordIdPolicyClass, idXpath, namespaces,
                metadataTransformations,externalRestServices);
    }
    public DataSource updateDataSourceZ3950Timestamp(String oldId, String id, String description, String schema, String namespace,
                                                     String address, String port, String database, String user, String password,
    ...
    public DataSource updateDataSourceZ3950IdList(String oldId, String id, String description, String schema, String namespace, String address,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceZ3950IdList(oldId, id, description, schema, namespace, address, port, database, user,
                password, recordSyntax, charset, filePath, recordIdPolicyClass, idXpath, namespaces, metadataTransformations,externalRestServices);
    }
    ...
    public DataSource updateDataSourceZ3950IdSequence(String oldId, String id, String description, String schema, String namespace,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceZ3950IdSequence(oldId, id, description, schema, namespace, address, port, database,
                user, password, recordSyntax, charset, maximumIdString, recordIdPolicyClass, idXpath, namespaces,
                metadataTransformations,externalRestServices);
    }
    ...
    public DataSource updateDataSourceFtp(String oldId, String id, String description, String schema, String namespace, String metadataFormat,
        ...
        return updateDataSourceFtp(oldId, id, description, schema, namespace, metadataFormat, isoFormat, charset,
                recordIdPolicyClass, idXpath, namespaces, recordXPath, server, user, password, ftpPath, metadataTransformations,externalRestServices);
    ...
    public DataSource updateDataSourceHttp(String oldId, String id, String description, String schema, String namespace, String metadataFormat,
        ...
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceHttp(oldId, id, description, schema, namespace, metadataFormat, isoFormat, charset,
                recordIdPolicyClass, idXpath, namespaces, recordXPath, url, metadataTransformations,externalRestServices);
    }
    public DataSource updateDataSourceHttp(String oldId, String id, String description, String schema, String namespace, String metadataFormat,
                                           String isoFormat, String charset, String recordIdPolicyClass, String idXpath,
    ...
    public DataSource updateDataSourceFolder(String oldId, String id, String description, String schema, String namespace, String metadataFormat,
                                             ...
                                             List<ExternalRestService> externalRestServices) throws IOException, DocumentException, ObjectNotFoundException, InvalidArgumentsException, IncompatibleInstanceException {
        Map<String, String> namespaces = new TreeMap<String, String>();
        namespaces.put(namespacePrefix, namespaceUri);
        return updateDataSourceFolder(oldId, id, description, schema, namespace, metadataFormat, isoFormat, charset,
                recordIdPolicyClass, idXpath, namespaces, recordXPath, sourcesDirPath, metadataTransformations,
                externalRestServices);
    }
