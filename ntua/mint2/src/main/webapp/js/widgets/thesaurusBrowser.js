function ThesaurusBrowser(containerId, options) {
	...
	if(this.options.collections != undefined) this.options.collection = this.options.collections[0];
...
ThesaurusBrowser.prototype.loadLanguages = function() {
	...
	$.ajax({
		...
		data : {
			...
			conceptScheme : this.options.conceptScheme,
		},
...
ThesaurusBrowser.prototype.getConceptDiv = function(concept) {
	...
	if(this.options.collections != undefined && concept.list0 == "false") {
