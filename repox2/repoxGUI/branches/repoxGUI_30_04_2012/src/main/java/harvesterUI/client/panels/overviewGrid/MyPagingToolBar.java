...
public class MyPagingToolBar extends ToolBar {
     ...
     */
    public MyPagingToolBar(final int pageSize, MainGrid mainGrid) {
        ...
        perPageCombo.addSelectionChangedListener(new SelectionChangedListener<SimpleComboValue<String>>() {
            ...
            public void selectionChanged(SelectionChangedEvent<SimpleComboValue<String>> se) {
                ...
                if(perPageCombo.isVisible()){
                    ...
                    Cookies.setCookie("perPageCombo01", perPageCombo.getSimpleValue(), expires, null, "/", false);
                }
            }
        });
        String perPageData = Cookies.getCookie("perPageCombo01");
