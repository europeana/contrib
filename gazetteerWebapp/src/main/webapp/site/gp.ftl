...
<#include "taglib.ftl"/>
	...
	<h1 class="text">Alexandria Digital Library - General Protocol (ADL-GP)</h1>
...
<#macro adlForm query>
<form method="post" action="services/gp">
...
<!--
	<div class="h2">XML Request - Get Capabilities</div>

<@adlForm query="get-capabilities"/>
-->
