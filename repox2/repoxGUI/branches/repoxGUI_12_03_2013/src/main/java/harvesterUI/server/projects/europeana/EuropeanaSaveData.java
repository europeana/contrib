...
public class EuropeanaSaveData {
        ...
        try {
            ...
            for(TransformationUI transformationUI: dataSourceUI.getMetadataTransformations()) {
                if(transformationUI.isMdr()){
                    MetadataTransformation metadataTransformation= LightSaveData.saveMdrTransformation(transformationUI);
                    ...
                    if(type.equals("oai")) {
                        ...
                        if(dataSourceUI.getRetrieveStartegy().equals("pt.utl.ist.repox.marc.DataSourceFolder")) {
                            ...
                            createdDataSource = repoxManagerEuropeana.getDataManager().updateDataSourceFolder(originalDSset, dataSourceUI.getDataSourceSet(),
                                    ...
                                    namespaces, dataSourceUI.getRecordRootName(), dataSourceUI.getDirPath(), metadataTransformations,externalRestServices);
    ...
    public static SaveDataResponse saveDataProvider(boolean update, DataProviderUI dataProviderUI, int pageSize) throws ServerSideException {
