...
public class DataManagerDefaultTest {
    ...
    private List<DataProvider> getTestDataProviders() {
        ...
        try{
            ...
            DataManagerDefault dataManager = new DataManagerDefault(configurationFile, transformationManager, repositoryPath, oldTasksFile);
            ...
            DataSource source1 = dataManager.createDataSourceOai(provider.getId(), "DS1_Id", "DS1_description",
                    ...
                    MetadataFormat.ese.name(), "http://bd1.inesc-id.pt:8080/repoxel/OAIHandler", "bmfinancas", null,null);
    ...
    public void testClasses() throws IOException, DocumentException, ClassNotFoundException, NoSuchMethodException, IllegalFileFormatException, SQLException, ParseException, AlreadyExistsException {
        ...
        DataManagerDefault dataManager2 = new DataManagerDefault(configurationFile, transformationManager, repositoryPath, oldTasksFile);
    ...
    public void testXml() throws IOException, DocumentException, ClassNotFoundException, NoSuchMethodException, IllegalFileFormatException, SQLException, ParseException, AlreadyExistsException {
        ...
        DataManagerDefault dataManagerReloaded = new DataManagerDefault(configurationFileAlt, transformationManager, repositoryPath, oldTasksFile);
