...
public class DataSetOperationsServiceImpl extends RemoteServiceServlet implements DataSetOperationsService {
    ...
    public Map<String,BaseModel> getAllDataSourceStatus(List<DataContainer> dataContainers) throws ServerSideException{
        Map<String,BaseModel> statusMap = new HashMap<String,BaseModel>();
        try {
    ...
    protected void getDSStatus(DataSourceUI dataSourceUI, Map<String,BaseModel> statusMap) throws ServerSideException{
        try {
            ...
            data.set("recordNum",dataSource.getNumberRecords());
