...
<p>
    <label for="dataSource.language"><fmt:message key="dataSource.language" /><em>*</em> </label>
    <stripes:select name="dataSource.language">
        <stripes:options-enumeration enum="eu.europeana.definitions.domain.Language"/>
    </stripes:select>
</p>
