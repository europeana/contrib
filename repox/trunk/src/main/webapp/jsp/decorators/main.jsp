				...
				*/
				...
				function formatItem(row) {
                    ...
                    if(row[0] == 'ag') {
						...
						resultString = row[4] + ' - ' + row[2];
					}
					else if(row[0] == 'ds') {
						resultString = row[6] + ' - ' + row[4] + ' - ' + row[2];
					}
				...
				$("#suggest").autocomplete('${pageContext.request.contextPath}/search', {
                    ...
                    if(row[0] == 'ag') {
                        newLocation = '${pageContext.request.contextPath}/springAggregator/viewAggregator.html?aggregatorId='
						+ row[1]
                    }

                    else if(row[0] == 'dp') {
                        newLocation = '${pageContext.request.contextPath}/dataProvider/ViewDataProvider.action?dataProviderId='
						+ row[3]
                    }

                    else if(row[0] == 'ds') {
                        newLocation = '${pageContext.request.contextPath}/dataProvider/ViewDataProvider.action?dataProviderId='
						+ row[3] + '&dataSourceId=' + row[6];
                    }
    ...
    <body>
		...
		<div class="navigation">
			<a href="${pageContext.request.contextPath}/">
				<img style="text-decoration: none; border: none;" src="${pageContext.request.contextPath}/jsp/images/repox-logo-16.png" alt="Homepage"/>
            ...
            <a href="${pageContext.request.contextPath}/propertiesForm.html">Administration</a>
