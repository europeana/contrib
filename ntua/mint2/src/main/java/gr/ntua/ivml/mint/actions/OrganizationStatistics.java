...
@Results({
	  @Result(name="input", location="organizationstatistics.jsp"),
	  @Result(name="error", location="organizationstatistics.jsp"),
	  @Result(name="success", location="organizationstatistics.jsp" )
	})
public class OrganizationStatistics extends GeneralAction{
	public static final Logger log = Logger.getLogger(ImportSummary.class );
		

	private String error="";
	@Action(value = "OrganizationStatistics")
