  ...
  public class BM25FBooleanWeight extends Weight {
    ...
    public BM25FBooleanWeight(IndexSearcher searcher, boolean disableCoord)
      ...
      for (int i = 0 ; i < clauses.size(); i++) {
        ...
        assert terms.size() == 1;
        Weight w = new BM25FBooleanTermQuery(terms.toArray(new Term[1])[0]).createWeight(searcher);
...
//        }
    ...
    @Override
    public Query getQuery() { return BM25FBooleanQuery.this; }
    ...
    public Explanation explain(AtomicReaderContext context, int doc)
      ...
      final int minShouldMatch =
        BM25FBooleanQuery.this.getMinimumNumberShouldMatch();
...
//      }
      ...
      if (!scoreDocsInOrder && topScorer && required.size() == 0) {
        return new BM25FBooleanScorer(this, disableCoord, minNrShouldMatch, required, optional, prohibited, maxCoord);
      }
