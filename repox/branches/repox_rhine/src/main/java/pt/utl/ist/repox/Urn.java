...
public class Urn {
	...
	public Urn(String urn) throws InvalidInputException{
		super();
		RepoxManager repoxManager = RepoxContextUtil.getRepoxManager();

		try {
			String[] parts = urn.substring(repoxManager.getBaseUrn().length()).split(URN_SEPARATOR, 2);
	...
	public String toString() {
		RepoxManager repoxManager = RepoxContextUtil.getRepoxManager();
		String baseUrn = repoxManager.getBaseUrn();
...
//		Urn urn = new Urn("urn:repox.ist.utl.pt:a1:ASD3");
		Urn urn = new Urn("urn:repox.ist.utl.pt:a1:ASD3;2008-01-29;asdasd:234324");
