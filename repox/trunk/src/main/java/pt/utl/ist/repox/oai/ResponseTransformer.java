...
public class ResponseTransformer {
	...
	public List<RecordRepox> splitResponseToRecords(File xmlFile, DataSource dataSource, File logFile)
		...
		while (iterator.hasNext()) {
			...
			if(currentElement.attribute("status") != null
				...
				try {
					if (currentElement.element("metadata").elements().get(0)!=null)
	...
	public static void main(String[] args) throws Exception {
        ...
        responseTransformer.splitResponseToRecords(new File("D:\\Projectos\\repoxdata\\[temp]OAI-PMH_Requests\\www.collectionconnection.nl_12900-ALL\\recordsRequest-104_2.xml"), null, new File("D:\\Projectos\\repoxdata\\[temp]OAI-PMH_Requests\\www.collectionconnection.nl_12900-ALL\\log.txt"));

        System.out.println("responseTransformer = " + responseTransformer);
