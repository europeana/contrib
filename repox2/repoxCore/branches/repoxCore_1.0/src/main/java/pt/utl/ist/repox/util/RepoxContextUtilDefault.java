        ...
        try {
            if(repoxManager == null) {
                ...
                if(!countriesFile.exists()){
                    ...
                    OutputStream out=new FileOutputStream(countriesFile);
                    ...
                    out.close();
                    inputStream.close();
//                    FileUtils.copyInputStreamToFile(inputStream, countriesFile);
                }
                ...
                repoxManager = new RepoxManagerDefault(configuration, DATA_PROVIDERS_FILENAME, STATISTICS_FILENAME, RECORD_COUNTS_FILENAME,
                        SCHEDULED_TASKS_FILENAME, RECOVERABLE_TASKS_FILENAME, METADATA_TRANSFORMATIONS_FILENAME, OLD_TASKS_FILENAME,EXTERNAL_SERVICES_FILENAME);
            }
