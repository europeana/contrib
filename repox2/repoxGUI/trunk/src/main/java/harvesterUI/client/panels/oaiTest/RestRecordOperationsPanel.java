...
public class RestRecordOperationsPanel extends ContentPanel {
    ...
    protected LabelToolItem operationsListLabel,recordFillLabel,recordsLabel,aggregatorsLabel,dataSourcesListLabel;
...
//        left.setStyleAttribute("paddingRight", "10px");
    ...
    private FieldSet createOperationsFieldSet() {
        ...
        SimpleComboBox<String> modificationOperationCombo = new SimpleComboBox<String>();
        ...
        Button b = new Button(HarvesterUI.CONSTANTS.submit(),new SelectionListener<ButtonEvent>() {
            @Override
