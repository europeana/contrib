...
public class XMLRecordFactory extends RecordFactory {
	private static final String identifierStart = "<oai:identifier>";
	private static final String identifierEnd = "</oai:identifier>";
	private static final String datestampStart = "<oai:datestamp>";
	private static final String datestampEnd = "</oai:datestamp>";
	private static final String setSpecStart = "<oai:setSpec>";
	private static final String setSpecEnd = "</oai:setSpec>";
	private static final String aboutStart = "<oai:about>";
	private static final String aboutEnd = "</oai:about>";
