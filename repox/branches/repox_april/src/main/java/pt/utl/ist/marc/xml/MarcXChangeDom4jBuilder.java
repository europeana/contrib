...
//    } 
    ...
    public static Document record2Dom(Record rec){
    	...
    	Element recEl=record2DomElement(rec, tmpRoot, null);
    	ret.remove(tmpRoot);
    	ret.add(recEl);
    	return ret;
    }
    
    public static Element record2DomElement(Record rec, Element parentElem){
    	return record2DomElement(rec, parentElem, null);
    }   
    
    public static Element record2DomElement(Record rec, Element parentElem, String namespacePrefix){
...
//        root.addAttribute(new QName("format", namespace), "Unimarc");
