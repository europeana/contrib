...
public abstract class CreateEditDataSourceActionBean extends RepoxActionBean {
    ...
    public CreateEditDataSourceActionBean() throws IOException, DocumentException {
        super();
        metadataTransformations = RepoxContextUtil.getRepoxManager().getMetadataTransformationManager().getMetadataTransformations();
...
//		context.getMessages().add(new LocalizableMessage("common.cancel.message"));
    ...
    public void validateCommonDataSourceProperties(ValidationErrors errors) throws DocumentException, IOException {
        ...
        if(getBeanDataSource() == null || getBeanDataSource().getMetadataFormat() == null){
            errors.add("dataSource", new LocalizableError("error.dataSource.metadataFormat"));
        }
        ...
        if(getBeanDataSource() == null || getBeanDataSource().getName() == null || getBeanDataSource().getName().trim().isEmpty()) {
            errors.add("dataSource", new LocalizableError("error.dataSource.name"));
        }

        if(getBeanDataSource() == null || getBeanDataSource().getNameCode() == null || getBeanDataSource().getNameCode().trim().isEmpty()) {
            errors.add("dataSource", new LocalizableError("error.dataSource.nameCode"));
        }

        /*
        if(getBeanDataSource() == null || getBeanDataSource().getExportPath() == null || getBeanDataSource().getExportPath().trim().isEmpty()) {
            errors.add("dataSource", new LocalizableError("error.dataSource.exportPath"));
        }
        */
