            ...
            <td>
                ...
                <p>
                    ...
                    <c:if test="${empty actionBean.dataSource.metadataFormat}">
                        <stripes:text id="otherFormat" value="ese" readonly="true" name="dataSource.metadataFormat" size="150px" />
                    </c:if>
                </p>
                ...
                <%--
                <p>
                    <label for="addNamespace4Record"><fmt:message key="dataSource.namespaces" /></label>
