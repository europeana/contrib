...
public abstract class DataSourceForm extends DefaultFormPanel {
    ...
    public DataSourceForm(FormData data) {
        ...
        newTransformationButton = new Button(HarvesterUI.CONSTANTS.newStr(),new SelectionListener<ButtonEvent>() {
            @Override
            public void componentSelected(ButtonEvent ce) {
                Dispatcher.get().dispatch(AppEvents.ViewAddMappingDialog);
            }
        });

//        if(HarvesterUI.useMdr()){
//            checkMdrTransformationsButton = new Button("Load MDR Data",new SelectionListener<ButtonEvent>() {
//                @Override
//                public void componentSelected(ButtonEvent ce) {
//                    mask("Loading MDR Data...");
//                    AsyncCallback<List<TransformationUI>> callback = new AsyncCallback<List<TransformationUI>>(){
//                        public void onFailure(Throwable caught) {
//                            new ServerExceptionDialog("Failed to get response from server",caught.getMessage()).show();
//                        }
//                        public void onSuccess(List<TransformationUI> transformationUIList) {
//                            unmask();
//                            if(transformationUIList.size() == 0){
//                                HarvesterUI.UTIL_MANAGER.getInfoBox("MDR Load Data","No Schema found");
//                                return;
//                            }
//
//                            transformationsStore.add(transformationUIList);
//                            HarvesterUI.UTIL_MANAGER.getSaveBox("MDR Load Data","MDR Mappings Loaded successfully");
//                        }
//                    };
//                    String metadataNamespaceStr = metadataNamespace.getValue();
//                    String schemaStr = schema.getValue();
//                    if(metadataNamespaceStr == null || metadataNamespaceStr.isEmpty()){
...
//                    }
//
//                    TransformationsServiceAsync transformationsServiceAsync = (TransformationsServiceAsync)Registry.get(HarvesterUI.TRANSFORMATIONS_SERVICE);
//                    transformationsServiceAsync.getMdrMappings(schemaStr,metadataNamespaceStr,callback);
//                }
//            });
//        }
    }
...
//        if(HarvesterUI.useMdr()){
//            transformContainer.add(checkMdrTransformationsButton, new HBoxLayoutData(new Margins(0, 0, UtilManager.DEFAULT_HBOX_BOTTOM_MARGIN, 5)));
//        }
    ...
    public void reloadSchemas(){
        if(dataSourceSchemaForm != null){
            dataSourceSchemaForm.reloadMetadataSchemas();
