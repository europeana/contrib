...
//	public enum Status { RUNNING, SLEEPING, OK }
    ...
    public Task.Status startIngest(String taskId, boolean fullIngest) {
        ...
        try {
            ...
            log.error(e.getMessage(), e);
            StringUtil.simpleLog("MessagingException: ERROR importing from Data Source with id " + id + ": " + e.getMessage(), this.getClass(), logFile);
            request.setStatus(RequestStatus.ABORTED);
        } catch (IOException e) {
            log.error(e.getMessage(), e);
    ...
    public static void main(String[] args)throws Exception{
        ...
        emailSender.setMailSender(mail);
        emailSender.sendEmail(recipientsEmail, fromEmail, subject, map, "C:\\Users\\GPedrosa\\Desktop\\indexSec.txt");
    }
