...
public class Iso2709TypeDetector {
	...
	public static BatchInfo.CharSet detectCharSet(File isoFile) throws IOException{
		...
		if(log.isDebugEnabled()) {
			System.out.println("PB4 clues - " + pb4Clues);
			System.out.println("Horizon clues - " + horizonClues);
			System.out.println("ISO8859-1 clues - " + iso8859Clues);
			System.out.println("ANSEL clues - " + anselClues);
		}
