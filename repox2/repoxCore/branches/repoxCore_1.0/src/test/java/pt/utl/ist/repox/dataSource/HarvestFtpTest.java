...
public class HarvestFtpTest {
    ...
    private final int RECORD_COUNT =1848;
    ...
    public void setUp() {
        try {
            ...
            dataSourceFtp = dataManager.createDataSourceFtp(provider.getId(),  DATA_SOURCE_ID, DATA_SOURCE_DESCRIPTION,
                    ...
                    SOURCE_ID_POLICYCLASS, SOURCE_IDXPATH, SOURCE_NAMESPACEURI,SOURCE_NAMESPACESPREFIX,SOURCE_RECORDXPATH, SOURCE_SERVER, SOURCE_USER, SOURCE_PASSWORD, SOURCE_ftpPATH,
                    null,null);
        }
