...
/* JDBC_3_ANT_KEY_BEGIN */
	...
	public void setAsciiStream(int parameterIndex, InputStream in) throws SQLException {
		checkOpen(); try { _stmt.setAsciiStream(parameterIndex, in); } catch (SQLException e) { handleException(e); }
	}

	public void setAsciiStream(int parameterIndex, InputStream in, long length) throws SQLException {
		checkOpen(); try { _stmt.setAsciiStream(parameterIndex, in, length); } catch (SQLException e) { handleException(e); }
	}

	public void setBinaryStream(int parameterIndex, InputStream in) throws SQLException {
		checkOpen(); try { _stmt.setBinaryStream(parameterIndex, in); } catch (SQLException e) { handleException(e); }
	}

	public void setBinaryStream(int parameterIndex, InputStream in, long length) throws SQLException {
		checkOpen(); try { _stmt.setBinaryStream(parameterIndex, in, length); } catch (SQLException e) { handleException(e); }
	}

	public void setBlob(int parameterIndex, InputStream in) throws SQLException {
		checkOpen(); try { _stmt.setBlob(parameterIndex, in); } catch (SQLException e) { handleException(e); }
	}

	public void setBlob(int parameterIndex, InputStream in, long length) throws SQLException {
		checkOpen(); try { _stmt.setBlob(parameterIndex, in, length); } catch (SQLException e) { handleException(e); }
	}

	public void setCharacterStream(int parameterIndex, Reader reader) throws SQLException {
		checkOpen(); try { _stmt.setCharacterStream(parameterIndex, reader); } catch (SQLException e) { handleException(e); }
	}
	...
	public void setClob(int parameterIndex, Reader reader) throws SQLException {
		checkOpen(); try { _stmt.setClob(parameterIndex, reader); } catch (SQLException e) { handleException(e); }
	}

	public void setClob(int parameterIndex, Reader reader, long length) throws SQLException {
		checkOpen(); try { _stmt.setClob(parameterIndex, reader, length); } catch (SQLException e) { handleException(e); }
	}

	public void setNCharacterStream(int parameterIndex, Reader reader) throws SQLException {
		checkOpen(); try { _stmt.setNCharacterStream(parameterIndex, reader); } catch (SQLException e) { handleException(e); }
	}

	public void setNCharacterStream(int parameterIndex, Reader reader, long length) throws SQLException {
		checkOpen(); try { _stmt.setNCharacterStream(parameterIndex, reader, length); } catch (SQLException e) { handleException(e); }
	}

	public void setNClob(int parameterIndex, NClob nc) throws SQLException {
		checkOpen(); try { _stmt.setNClob(parameterIndex, nc); } catch (SQLException e) { handleException(e); }
	}

	public void setNClob(int parameterIndex, Reader reader) throws SQLException {
		checkOpen(); try { _stmt.setNClob(parameterIndex, reader); } catch (SQLException e) { handleException(e); }
	}

	public void setNClob(int parameterIndex, Reader reader, long length) throws SQLException {
		checkOpen(); try { _stmt.setNClob(parameterIndex, reader, length); } catch (SQLException e) { handleException(e); }
	}

	public void setNString(int parameterIndex, String str) throws SQLException {
		checkOpen(); try { _stmt.setNString(parameterIndex, str); } catch (SQLException e) { handleException(e); }
	}

	public void setRowId(int parameterIndex, RowId id) throws SQLException {
		checkOpen(); try { _stmt.setRowId(parameterIndex, id); } catch (SQLException e) { handleException(e); }
	}

	public void setSQLXML(int parameterIndex, SQLXML sql) throws SQLException {
		checkOpen(); try { _stmt.setSQLXML(parameterIndex, sql); } catch (SQLException e) { handleException(e); }
	}
