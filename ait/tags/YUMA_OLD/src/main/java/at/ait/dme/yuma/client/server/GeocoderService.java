...
public interface GeocoderService extends RemoteService {
	...
	String getPlacename(String europeanaUri, String mapUrl, 
			XYCoordinate coordinate) throws GeocoderException;
	SemanticTag[] getTags(String europeanaUri, String mapUrl, 
			XYCoordinate lowerLeft, XYCoordinate upperRight) throws GeocoderException;
