...
//            int extra = 0;
    ...
    private DataSourceUI parseDataSource(DataSourceContainer dataSourceContainer,DataProviderUI dataProviderUI) throws ServerSideException{
        ...
        // Eudml only
//        if(dataSourceContainer instanceof DataSourceContainerEuDml){
//            DataSourceContainerEuDml dsEudml = (DataSourceContainerEuDml)dataSourceContainer;
//            newDataSourceUI.setStoreInYadda(dsEudml.isStoreInYadda());
//        }
