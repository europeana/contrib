...
public class DataSourceDirectoryImporter extends DataSource {
	...
	public DataSourceDirectoryImporter(DataProvider dataProvider, String id, String description, String metadataFormat,
			...
			Map<String, MetadataTransformation> metadataTransformations, String recordXPath, Map<String, String> namespacesMap) {
	...
	public DataSourceDirectoryImporter(DataProvider dataProvider, String id, String description, String metadataFormat,
			...
			RecordIdPolicy recordIdPolicy, Map<String, MetadataTransformation> metadataTransformations, String recordXPath, Map<String, String> namespaces) {
		this(dataProvider, id, description, metadataFormat, extractStrategy, sourcesDirPath, recordIdPolicy, metadataTransformations, recordXPath, namespaces);
		this.characterEncoding = characterEncoding;
	}

	@Override
	public Task.Status ingestRecords(File logFile, boolean fullIngest) throws IOException, DocumentException, SQLException {
