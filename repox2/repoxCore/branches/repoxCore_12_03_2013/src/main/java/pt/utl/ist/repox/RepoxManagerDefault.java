...
public class RepoxManagerDefault implements RepoxManager {
    ...
    public RepoxManagerDefault(RepoxConfigurationDefault configuration, String dataProvidersFilename, String statisticsFilename,
                               ...
                               String externalServicesFilename, String metadataSchemasFilename) throws DocumentException, ParseException, SQLException, IOException, ClassNotFoundException, NoSuchMethodException, IllegalFileFormatException {
		...
		this.dataManager = new DataManagerDefault(dataProvidersFile, this.metadataTransformationManager, this.metadataSchemaManager, repositoryPath, oldTasksFile);
