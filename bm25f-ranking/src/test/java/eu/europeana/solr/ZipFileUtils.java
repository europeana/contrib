...
public class ZipFileUtils {
	...
	public static List<SolrInputDocument> readDocuments(String path){
		try {
			...
			Enumeration<ZipEntry> zipEntries = zFile.getEntries();
			...
			while(zipEntries.hasMoreElements()){
				...
				//create an XML reader required to convert the document through the XMLLoader of solr
				XMLStreamReader reader = factory.createXMLStreamReader(in);
				//get to the first START_ELEMENT (doc) as the XMLLoader does not handle START_DOC event types
				reader.next();
