...
public class MetadataRecord implements Serializable {
    ...
    @Column
    @ManyToMany(mappedBy = "metadataRecords", cascade = CascadeType.ALL)
    ...
    /**
     * Add a Request to the MetadataRecord.
     *
    ...
    public void addRequest(Request request) {
        ...
        if (!request.getMetadataRecords().contains(this)) {
            request.getMetadataRecords().add(this);
        }
    }
     ...
     *
     * @return List<Request>
     * @see eu.europeana.repox2sip.models.Request
     */
     ...
     *
     * @return Float   the process identifier
     */
    public Float getPid() {
        return pid;
    }
     ...
     *
     * @param pid Float  the process identifier
     */
     ...
     * @see eu.europeana.repox2sip.models.MetadataRecordStatus
     */
