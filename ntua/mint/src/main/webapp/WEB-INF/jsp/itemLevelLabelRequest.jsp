...
<span id="setlabel">
<%} %>
<h2>Item Label (Optional)</h2>
<div style="color: #000000; margin-top: -15px; margin-bottom: 5px;margin-left:5px;">
Drag & drop a node from the tree to the left in the box below, to set the item label. 

This label that will be used as the Item name in the Item Overview.
Possible values could be the item label or the item id.
