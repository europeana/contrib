...
//                    loginData.set("language",language);
    ...
    public ResponseState resetUserPassword(String userName, String email, ProjectType projectType) throws ServerSideException {
        try {
            SAXReader reader = new SAXReader();
            Document document = reader.read(usersFile);
            ...
            for(Object node: list) {
                ...
                if(usr.equals(userName) && mail.equals(email)) {
                    ...
                    result = sendUserDataEmail(userName,email,resetPassword);
                }
            }
