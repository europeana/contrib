...
<table class="mainTable">
    <thead>
        <tr>
            ...
            <th class="mainHeader">
                <fmt:message key="aggregator.name"/>
        ...
        <c:choose>
            <c:when test="${currentItem.class.name == 'pt.utl.ist.repox.data.AggregatorRepox'}">
                ...
                <tr>
                    ...
                    <td class="${cellClass}" style="text-align:left;">
                        <stripes:link href="/aggregator/ViewAggregator.action?aggregatorId=${repox:encode(aggregator.id)}">
                            <c:out escapeXml="true" value="${aggregator.name}"/>
                        </stripes:link>
                    </td>
                    <td colspan="8" class="${cellClass}"></td>
                </tr>
            </c:when>
            <c:when test="${currentItem.class.name == 'pt.utl.ist.repox.data.DataProvider'}">
                ...
                <tr>
                    ...
                    <td class="${cellClass}" style="text-align:left;">
                        <%--<c:out value="${dataProvider.aggregator.idDb}"/>--%>
                        <c:out value="${dataProvider.aggregator.nameCode}"/>
                    </td>
                    <td class="${cellClass}" style="text-align:left;">
                        <stripes:link href="/aggregator/ViewAggregator.action?aggregatorId=${repox:encode(dataProvider.aggregator.id)}">
            ...
            <c:otherwise>
                ...
                <tr>
                    ...
                    <td class="${cellClass}" style="text-align:left">
                        ...
                        <%--<c:out value="${dataSource.dataProvider.aggregator.idDb}"/>--%>
                    </td>
                    <td class="${cellClass}" style="text-align:left">
                        <stripes:link href="/aggregator/ViewAggregator.action?aggregatorId=${repox:encode(dataSource.dataProvider.aggregator.id)}">
