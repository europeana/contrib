...
//                getPagingToolBar().setEnabled(true);
                ...
                topToolbar.getSearchCombo().clear();
                topToolbar.getSearchCombo().populateSearchCombo();
        ...
        service.getMainData(config, callback);
    }
...
//        filterPanel.setAnimCollapse(true);
    ...
    private void editPanelInfo(DataSourceUI dataSourceUI){
        ...
        if(viewDsInfoPanel.isExpanded()){
            ...
            viewDsInfoPanel.setHeading(HarvesterUI.CONSTANTS.viewDataSet()+": " + dataSourceUI.getDataSourceSet() +
