...
public class DataSourceOAIForm extends DataSourceForm {
    ...
    private void createDataSet() {
        ...
        dataSourceSchemaForm.addSchemaFormPart(dataSet,smallFixedFormData,formData);
    ...
    public void saveData(){
        ...
        if(HarvesterUI.getProjectType().equals("EUROPEANA"))
            saveDataSource(dataSourceUI,oldDataSetId,"oai",dataSourceSchemaForm.getSchema().getValue(),dataSourceSchemaForm.getMetadataNamespace().getValue(),
