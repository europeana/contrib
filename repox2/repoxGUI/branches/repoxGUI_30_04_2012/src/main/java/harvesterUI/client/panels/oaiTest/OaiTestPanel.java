...
public class OaiTestPanel extends ContentPanel {
    ...
    public OaiTestPanel() {
        ...
        check = new Button(HarvesterUI.CONSTANTS.check(),new SelectionListener<ButtonEvent>() {
            @Override
            public void componentSelected(ButtonEvent ce) {
                ...
                if(serverUrl == null || ((String)serverUrl.getValue()).trim().equals(""))
                    ...
                    service.checkOAIURL(((String)serverUrl.getValue()).trim(), callback);
                }
            }
        });
