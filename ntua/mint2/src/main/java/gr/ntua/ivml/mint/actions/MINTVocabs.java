...
public class MINTVocabs extends GeneralAction {
	...
	private String property = "http://mint.image.ece.ntua.gr/properties/iso_639_1";
	...
	public String topConcepts() {
		...
		JSONArray concepts = JSONUtils.toNetSfJSONArray(JSONUtils.toJSON(skos.getTopConcepts(this.getProperty())));
	...
	public String concepts() {
		...
		JSONArray concepts = JSONUtils.toNetSfJSONArray(JSONUtils.toJSON(skos.getConcepts(this.getProperty())));
