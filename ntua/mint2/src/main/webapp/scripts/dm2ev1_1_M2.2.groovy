...
for(Element providedCHO: handlers) {
    if(providedCHO != null){
		...
		providedCHO.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.1/Document", "Document");
		providedCHO.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.1/File", "File");
		...
		providedCHO.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.1/Manuscript", "Manuscript");
		providedCHO.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.1/Page", "Page");
		providedCHO.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.1/Photo", "Photo");
	}
}
