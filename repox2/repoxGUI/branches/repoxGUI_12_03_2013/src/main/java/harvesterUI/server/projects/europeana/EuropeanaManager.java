...
//            DecimalFormat dec = new DecimalFormat("#.##");
    ...
    public BaseModel loadAdminFormInfo() throws ServerSideException{
        try{
            ...
            if(properties.getProperty("ldapHost") != null)
                adminInfo.set("ldapHost",properties.getProperty("ldapHost"));
            if(properties.getProperty("ldapUserPrefix") != null)
                adminInfo.set("ldapUserPrefix",properties.getProperty("ldapUserPrefix"));
            if(properties.getProperty("ldapLoginDN") != null)
                adminInfo.set("ldapLoginDN",properties.getProperty("ldapLoginDN"));
            if(properties.getProperty("mdrUrl") != null)
                adminInfo.set("mdrUrl",properties.getProperty("mdrUrl"));
    ...
    public void saveAdminFormInfo(BaseModel results) throws ServerSideException{
        try{
            ...
            if(results.get("mdrUrl") == null)
                properties.setProperty("mdrUrl","");
            else
                properties.setProperty("mdrUrl",(String)results.get("mdrUrl"));
        ...
        try{
            ...
            if(data.get("prefix").equals("AGG")){
                ...
                for(DataProvider dataProvider : aggregator.getDataProviders()){
                    ...
                    if(dataProvider.getDataSourceContainers().size() == 1){
                        DataSourceContainer dataSourceContainer = getFirstElementOfCollection(dataProvider.getDataSourceContainers().values());
