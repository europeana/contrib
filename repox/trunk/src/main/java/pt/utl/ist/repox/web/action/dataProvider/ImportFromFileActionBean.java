...
import pt.utl.ist.repox.data.load.DataProviderLoader;
	...
	public Resolution submitFile() {
		try {
			...
			for (DataProvider dataProviderToImport : dataProvidersToImport) {
				DataProvider loadedDataProvider = dataManager.getDataProvider(dataProviderToImport.getId());
				...
				if(loadedDataProvider != null) {
					dataManager.updateDataProvider(dataProviderToImport, dataProviderToImport.getId());
				}
				else {
					dataManager.saveDataProvider(dataProviderToImport);
				}
