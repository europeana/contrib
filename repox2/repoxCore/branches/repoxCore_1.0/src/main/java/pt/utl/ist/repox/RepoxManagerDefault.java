...
public class RepoxManagerDefault implements RepoxManager {
    ...
    public RepoxManagerDefault(RepoxConfigurationDefault configuration, String dataProvidersFilename, String statisticsFilename,
                               ...
                               String externalServicesFilename) throws DocumentException, ParseException, SQLException, IOException, ClassNotFoundException, NoSuchMethodException, IllegalFileFormatException {
		...
		this.dataManager = new DataManagerDefault(dataProvidersFile, this.metadataTransformationManager, repositoryPath, oldTasksFile);
