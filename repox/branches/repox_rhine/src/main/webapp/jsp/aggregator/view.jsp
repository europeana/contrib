...
<table class="mainTable">
        ...
        <th class="mainHeader" colspan="8">
            <stripes:form action="/aggregator/CreateEditAggregator.action" acceptcharset="UTF-8">
                ...
                <div style="float:left; width: 80%;">
                    ...
                    (<stripes:link class="header" href="/aggregator/ViewAggregator.action?aggregatorId=${actionBean.aggregator.id}">
    ...
    <tr>
        ...
        <th class="mainHeader"><fmt:message key="dataProvider" /></th>
    </tr>
