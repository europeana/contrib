...
public class RepoxManager {
    ...
    public RepoxManager(RepoxConfiguration configuration, String dataProvidersFilename, String statisticsFilename,
                        ...
                        String metadataTransformationsFilename) throws DocumentException, ParseException, SQLException, IOException, ClassNotFoundException, NoSuchMethodException, IllegalFileFormatException, Repox2SipException {
        ...
        if(configuration.isConfigurationFileOk()){
            ...
            List<DataSource> dataSourceList = dataManager.loadDataSources();

            this.accessPointsManager = AccessPointManagerFactory.getInstance(configuration);
            accessPointsManager.initialize(dataSourceList);
