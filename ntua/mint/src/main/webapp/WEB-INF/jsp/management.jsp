...
%>
		...
		<s:form cssClass="athform" theme="mytheme" style="width:370px;border: solid 1px silver;margin:0;padding:0;">
			...
			<ol>
				...
				<li><s:textfield name="seluser.accountCreated" label="Account created" readonly="true" value="%{getText('format.date',{seluser.accountCreated})}" cssStyle="width:190px;"/></li>
