...
public class DataSourceOai extends DataSource {
	...
	public DataSourceOai(DataProvider dataProvider, String id, String description, String metadataFormat,
			...
			Map<String, MetadataTransformation> metadataTransformations, String name, String nameCode, long idDb, String exportPath) {
		this(dataProvider, id, description, metadataFormat, recordIdPolicy, metadataTransformations, name, nameCode, idDb, exportPath);
		this.id = id;
		this.oaiSourceURL = oaiSourceURL;
		this.oaiSet = oaiSet;
	}
