...
public class LastIngestRenderer implements GridCellRenderer<ModelData> {
    ...
    public Object render(ModelData model, String property, ColumnData config, int rowIndex, int colIndex,
        ...
        if(model instanceof DataSourceUI || model instanceof DataProviderUI) {
...
//                        layout.setHBoxLayoutAlign(HBoxLayout.HBoxLayoutAlign.MIDDLE);
                ...
                final Date schedule = dataSourceUI.getOldTasks().get(dataSourceUI.getOldTasks().size()-1).getDate();
//                        String nextDate = dataSourceUI.getOldTasks().get(dataSourceUI.getOldTasks().size()-1).getOnlyDate();
                ...
                String nextTime = dataSourceUI.getOldTasks().get(dataSourceUI.getOldTasks().size()-1).getOnlyTime();

                // Add filter data
                dataSourceUI.setLastIngest(schedule);
